- [Admin auth design](admin-auth-design.md) — admin uses custom locked-signup auth (invite code + seeded admin), NOT Clerk; never reopen signup or hardcode a default password. Storefront still uses Clerk.
